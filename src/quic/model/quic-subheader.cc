  ...
  switch (m_frameType)
    {
      ...
      case RST_STREAM:
        ...
        os << "|Stream Id " << m_streamId << "|"; // final "\n" removed
        os << "|Application Error Code " << m_errorCode << "|"; // final "\n" removed
        os << "|Final Offset " << m_offset << "|"; // final "\n" removed
        break;

      case CONNECTION_CLOSE:

        os << "|Application Error Code " << TransportErrorCodeToString () << "|"; // final "\n" removed
        os << "|Reason Phrase Length " << m_reasonPhraseLength << "|"; // final "\n" removed
        os << "|Reason Phrase ";
        for (auto& elem : m_reasonPhrase)
          {
            os << elem;
      ...
      case MAX_DATA:
        ...
        os << "|Maximum Data " << m_maxData << "|"; // final "\n" removed
        break;

      case MAX_STREAM_DATA:

        os << "|Stream Id " << m_streamId << "|"; // final "\n" removed
        os << "|Maximum Stream Data " << m_maxStreamData << "|"; // final "\n" removed
        break;

      case MAX_STREAM_ID:
        os << "|Maximum Stream Id " << m_maxStreamId << "|"; // final "\n" removed
        break;
      ...
      case NEW_CONNECTION_ID:
        ...
        os << "|Sequence " << m_sequence << "|"; // final "\n" removed
        os << "|Connection Id " << m_connectionId << "|"; // final "\n" removed
        //os << "|Stateless Reset Token " << m_statelessResetToken << "|"; // final "\n" removed
        break;
      ...
      case ACK:
        ...
        os << "|Largest Acknowledged " << m_largestAcknowledged << "|"; // final "\n" removed
        os << "|Ack Delay " << m_ackDelay << "|"; // final "\n" removed
        os << "|Ack Block Count " << m_ackBlockCount << "|"; // final "\n" removed
        os << "|First Ack Block " << m_firstAckBlock << "|"; // final "\n" removed
        for (uint64_t j = 0; j < m_ackBlockCount; j++)
          {
            os << "|Gap " << m_gaps[j] << "|"; // final "\n" removed
            os << "|Additional Ack Block " << m_additionalAckBlocks[j] << "|"; // final "\n" removed
          }
        break;

      case PATH_CHALLENGE:

        os << "|Data " << (uint64_t)m_data << "|"; // final "\n" removed
        break;
