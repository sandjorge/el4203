...
// JSA: according to https://gitlab.com/cttc-lena/nr/-/issues/159#note_1617404158
// 
// void
...
//             m_lcMap.at(lcId)->m_rlcTransmissionQueueSize = 0; // https://gitlab.com/cttc-lena/nr/-/issues/159
//         }
//         else
//         {
...
NrMacSchedulerLCG::AssignedData(uint8_t lcId, uint32_t size, std::string type)
{
                ...
                // data to be transmitted
    {
        ...
        {
            // we can transmit everything from the queue, reset it
            NS_LOG_DEBUG(Simulator::Now().GetSeconds()<<" Queue: "<<m_lcMap.at(lcId)->m_rlcTransmissionQueueSize);
